...
public class SplashActivity extends Activity implements UpdateAppCallBack {
	...
	// private void test() {
	// new AsyncHttpClient().get("http://www.baidu.com",
	...
	// }
	// private void test2() {
	// new AsyncHttpClient().get("http://www.baidu.com",new
	// AsyncHttpResponseHandler() {
	//
	// @Override
	// public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
	// LogUtil.D("onSuccess: "+new String(arg2));
	// }
	//
	// @Override
	...
	private void test3() {
		new HCKHttpClient().get("http://www.baidu.com",
	...
	// if (userBean != null) {
	// userName = Constant.APP_NAME + userBean.getUserId();
	...
	// }
	// RequestParams params = new RequestParams();
	// params.put("userId", Constant.APP_NAME + userBean.getUserId());
